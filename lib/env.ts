...
const envSchema = z
  .object({
    ...
    CREATOR_ACCOUNT_REQUIRED_FOR_SUBMISSION: booleanEnv,
    NEXTAUTH_URL: z.string().url().optional(),
    NEXTAUTH_SECRET: z.string().min(1).optional(),
    CREATOR_ADMIN_EMAILS: z.string().optional(),
    CREATOR_ADMIN_PASSWORD: z.string().min(12).optional(),
    INVITE_ADMIN_CODE: z.string().min(6).optional(),
    ...
    NEXT_PUBLIC_ANDROID_APP_STORE_URL: z.string().url().optional(),
    NEXT_PUBLIC_APP_DEEP_LINK: z.string().min(1).optional(),
    CREATOR_DEFERRED_DEEP_LINK_TEMPLATE: z.string().min(1).optional(),
    APPLE_APP_STORE_PROVIDER_TOKEN: z.string().min(1).optional(),
    NEXT_PUBLIC_CREATOR_DISCORD_CONTACT_URL: z.string().url().optional(),
    ...
    PAYMENT_HANDOFF_SECRET: z.string().min(32).optional(),
    STRIPE_ANALYSIS_PRICE_CENTS: z.coerce.number().int().min(50).default(499),
    STRIPE_EVALUATION_PRICE_ID: z.string().min(1).optional(),
    STRIPE_EVALUATION_PACK_3_PRICE_ID: z.string().min(1).optional(),
    STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_ID: z.string().min(1).optional(),
    STRIPE_EVALUATION_PACK_3_PRICE_CENTS: z.coerce.number().int().min(50).default(999),
    STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_CENTS: z.coerce.number().int().min(50).default(499),
    STRIPE_MOBILE_WEEKLY_PRICE_ID: z.string().min(1).optional(),
    STRIPE_MOBILE_MONTHLY_PRICE_ID: z.string().min(1).optional(),
    STRIPE_MOBILE_YEARLY_PRICE_ID: z.string().min(1).optional(),
    STRIPE_MOBILE_LIFETIME_PRICE_ID: z.string().min(1).optional(),
    STRIPE_MOBILE_WEEKLY_PRICE_CENTS: z.coerce.number().int().min(50).default(499),
...
export const env = envSchema.parse({
  ...
  CREATOR_ACCOUNT_REQUIRED_FOR_SUBMISSION: process.env.CREATOR_ACCOUNT_REQUIRED_FOR_SUBMISSION,
  NEXTAUTH_URL: process.env.NEXTAUTH_URL,
  NEXTAUTH_SECRET: process.env.NEXTAUTH_SECRET,
  CREATOR_ADMIN_EMAILS: process.env.CREATOR_ADMIN_EMAILS,
  CREATOR_ADMIN_PASSWORD: process.env.CREATOR_ADMIN_PASSWORD,
  INVITE_ADMIN_CODE: process.env.INVITE_ADMIN_CODE,
  ...
  NEXT_PUBLIC_ANDROID_APP_STORE_URL: process.env.NEXT_PUBLIC_ANDROID_APP_STORE_URL || undefined,
  NEXT_PUBLIC_APP_DEEP_LINK: process.env.NEXT_PUBLIC_APP_DEEP_LINK,
  CREATOR_DEFERRED_DEEP_LINK_TEMPLATE: process.env.CREATOR_DEFERRED_DEEP_LINK_TEMPLATE || undefined,
  APPLE_APP_STORE_PROVIDER_TOKEN: process.env.APPLE_APP_STORE_PROVIDER_TOKEN || undefined,
  NEXT_PUBLIC_CREATOR_DISCORD_CONTACT_URL: process.env.NEXT_PUBLIC_CREATOR_DISCORD_CONTACT_URL,
  ...
  PAYMENT_HANDOFF_SECRET: process.env.PAYMENT_HANDOFF_SECRET,
  STRIPE_ANALYSIS_PRICE_CENTS: process.env.STRIPE_ANALYSIS_PRICE_CENTS,
  STRIPE_EVALUATION_PRICE_ID: process.env.STRIPE_EVALUATION_PRICE_ID,
  STRIPE_EVALUATION_PACK_3_PRICE_ID: process.env.STRIPE_EVALUATION_PACK_3_PRICE_ID,
  STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_ID: process.env.STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_ID,
  STRIPE_EVALUATION_PACK_3_PRICE_CENTS: process.env.STRIPE_EVALUATION_PACK_3_PRICE_CENTS,
  STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_CENTS: process.env.STRIPE_EXTRA_POTENTIAL_IMAGE_PRICE_CENTS,
  STRIPE_MOBILE_WEEKLY_PRICE_ID: process.env.STRIPE_MOBILE_WEEKLY_PRICE_ID,
  ...
  STRIPE_MOBILE_LIFETIME_PRICE_ID: process.env.STRIPE_MOBILE_LIFETIME_PRICE_ID,
  STRIPE_MOBILE_WEEKLY_PRICE_CENTS: process.env.STRIPE_MOBILE_WEEKLY_PRICE_CENTS,
...
export function getRuntimeReadiness() {
  const checks: RuntimeReadinessCheck[] = [
    ...
    },
    {
      ...
      required: false,
      message: 'Required only when GPT Image potential-improvement generation is enabled',
    },
    {
      key: 'IMAGE_STORAGE',
