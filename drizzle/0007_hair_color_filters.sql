...
ALTER TABLE "users" ADD COLUMN IF NOT EXISTS "skin_color" text;
--> statement-breakpoint
ALTER TABLE "anonymous_profiles" ADD COLUMN IF NOT EXISTS "hair_color" text;
--> statement-breakpoint
ALTER TABLE "anonymous_profiles" ADD COLUMN IF NOT EXISTS "skin_color" text;
--> statement-breakpoint
ALTER TABLE "photos" ADD COLUMN IF NOT EXISTS "hair_color" text;
--> statement-breakpoint
ALTER TABLE "photos" ADD COLUMN IF NOT EXISTS "skin_color" text;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "photos_skin_color_idx" ON "photos" USING btree ("skin_color");
--> statement-breakpoint
